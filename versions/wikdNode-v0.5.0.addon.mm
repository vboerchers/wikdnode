...
<node TEXT="wikdNode" FOLDED="false" ID="ID_1723255651" CREATED="1283093380553" MODIFIED="1358477985373" BACKGROUND_COLOR="#97c7dc" LINK="https://bitbucket.org/lcrees/wikdnode/">
...
<attribute NAME="version" VALUE="v0.5.0" OBJECT="org.freeplane.features.format.FormattedObject|v0.5.0|number:decimal:#0.####"/>
...
<node TEXT="description" POSITION="left" ID="ID_143630176" CREATED="1357715826843" MODIFIED="1358477985401">
<edge COLOR="#ff0000"/>
<richcontent TYPE="NOTE">
...
<node ID="ID_419235551" CREATED="1357715987721" MODIFIED="1358055914114"><richcontent TYPE="NODE">
...
<node TEXT="changes" POSITION="left" ID="ID_1790870178" CREATED="1357715826877" MODIFIED="1358477985404">
<edge COLOR="#0000ff"/>
<richcontent TYPE="NOTE">
...
<node TEXT="license" POSITION="left" ID="ID_1348143779" CREATED="1357715826886" MODIFIED="1358477985407">
<edge COLOR="#00ff00"/>
<richcontent TYPE="NOTE">
...
<node TEXT="preferences.xml" POSITION="left" ID="ID_1772733941" CREATED="1357715826946" MODIFIED="1358477985412">
<edge COLOR="#ff00ff"/>
<richcontent TYPE="NOTE">
...
<node TEXT="default.properties" POSITION="left" ID="ID_1954124232" CREATED="1357715826968" MODIFIED="1358477985415">
<edge COLOR="#00ffff"/>
<richcontent TYPE="NOTE">
...
<node TEXT="translations" POSITION="left" ID="ID_1430168348" CREATED="1357715826977" MODIFIED="1358477985418">
<edge COLOR="#ffff00"/>
<richcontent TYPE="NOTE">
...
<attribute_layout NAME_WIDTH="100" VALUE_WIDTH="100"/>
<node TEXT="en" ID="ID_1245393964" CREATED="1357715826986" MODIFIED="1358308811831">
<attribute_layout NAME_WIDTH="130" VALUE_WIDTH="130"/>
...
<node TEXT="de" ID="ID_726128733" CREATED="1357715826986" MODIFIED="1358308813253">
...
<node TEXT="deinstall" POSITION="left" ID="ID_1844997656" CREATED="1357715826998" MODIFIED="1358477985421">
<edge COLOR="#7c0000"/>
<richcontent TYPE="NOTE">
...
<node TEXT="scripts" POSITION="right" ID="ID_1324856264" CREATED="1357715827025" MODIFIED="1358477985434">
<edge COLOR="#00007c"/>
<richcontent TYPE="NOTE">
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.every {&#x9;it.text = it.plainText.toUpperCase() }&#xa;" ID="ID_13381175" CREATED="1358478000728" MODIFIED="1358478000728"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.every { it.text = it.plainText.toLowerCase() }&#xa;" ID="ID_386348556" CREATED="1358478000729" MODIFIED="1358478000730"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;def child = null&#xa;c.selecteds.every { child = it.createChild(it.text) }&#xa;c.select(child)&#xa;" ID="ID_299685138" CREATED="1358478000731" MODIFIED="1358478000732"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;def parent = null&#xa;c.selecteds.every {&#xa;  parent = it.parent&#xa;  parent.text = it.text&#xa;  it.delete()&#xa;}&#xa;c.select(parent)&#xa;" ID="ID_288491727" CREATED="1358478000733" MODIFIED="1358478000733"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def joinText(String mark) {&#xa;    node.text = SU.join(c.selecteds.collect { SU.trim(it.plainText) }.toArray(), mark)&#xa;    c.selecteds.tail().each { it.delete() }&#xa;}&#xa;joinText(&apos;, &apos;)&#xa;" ID="ID_1181598646" CREATED="1358478000736" MODIFIED="1358478000737"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def joinText(String mark) {&#xa;    node.text = SU.join(c.selecteds.collect { SU.trim(it.plainText) }.toArray(), mark)&#xa;    c.selecteds.tail().each { it.delete() }&#xa;}&#xa;joinText(&apos; &apos;)&#xa;" ID="ID_1720085597" CREATED="1358478000738" MODIFIED="1358478000739"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def splitText(mark) {&#xa;&#x9;mark = Pattern.quote(mark ? mark : &apos;&apos;)&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false)&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos;.&apos;)&#xa;" ID="ID_818058604" CREATED="1358478000744" MODIFIED="1358478000744"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def splitText(mark) {&#xa;&#x9;mark = Pattern.quote(mark ? mark : &apos;&apos;)&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false)&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos;,&apos;)&#xa;" ID="ID_729747587" CREATED="1358478000745" MODIFIED="1358478000746"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def splitText(mark) {&#xa;&#x9;mark = Pattern.quote(mark ? mark : &apos;&apos;)&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false)&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos; &apos;)&#xa;" ID="ID_1946219351" CREATED="1358478000747" MODIFIED="1358478000748"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def trimPrompt(String pattern, Boolean start, String msg) {&#xa;&#x9;def mark = ui.showInputDialog(node.delegate, msg, &apos;&apos;)&#xa;&#x9;if (mark != null) {&#xa;&#x9;   mark = Pattern.quote(start ? pattern + mark : mark + pattern)&#xa;&#x9;   c.selecteds.every { it.text = SU.trim( it.plainText.replaceFirst(mark, &apos;&apos;)) }&#xa;&#x9;}&#xa;}&#xa;trimPrompt(&apos;^{1}&apos;, true, &apos;Enter characters to delete from text start...&apos;)&#xa;&#xa;" ID="ID_1565367867" CREATED="1358478000754" MODIFIED="1358478000755"/>
</node>
</node>
<node TEXT="zips" POSITION="right" ID="ID_269135974" CREATED="1357715827053" MODIFIED="1358477985473">
<edge COLOR="#007c00"/>
<richcontent TYPE="NOTE">
...
<node TEXT="images" FOLDED="true" POSITION="right" ID="ID_112966804" CREATED="1357715827065" MODIFIED="1358477985480">
<edge COLOR="#7c007c"/>
<richcontent TYPE="NOTE">
