...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.every {&#x9;it.text = it.plainText.toUpperCase() }&#xa;" ID="ID_1230893354" CREATED="1359741234244" MODIFIED="1359741234255"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.every { it.text = it.plainText.toLowerCase() }&#xa;" ID="ID_1429813739" CREATED="1359741234256" MODIFIED="1359741234256"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;def child&#xa;&#xa;c.selecteds.toList().every { child = it.createChild(it.text) }&#xa;&#xa;c.select(child)&#xa;" ID="ID_1478847698" CREATED="1359741234257" MODIFIED="1359741234258"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;def parent&#xa;def wipe = []&#xa;&#xa;c.selecteds.toList().each {&#xa;  parent = it.parent&#xa;  parent.text = it.text&#xa;  wipe.add(it)&#xa;}&#xa;&#xa;wipe.toList().each { it.delete() }&#xa;&#xa;c.select(parent)&#xa;" ID="ID_171095581" CREATED="1359741234260" MODIFIED="1359741234261"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def joinText(String mark) {&#xa;    node.text = SU.join(&#xa;&#x9;&#x9;c.selecteds.collect { SU.trim(it.plainText) }.toArray(), mark&#xa;&#x9;)&#xa;    c.selecteds.tail().each { it.delete() }&#xa;}&#xa;&#xa;joinText(&apos;, &apos;)&#xa;" ID="ID_1169135368" CREATED="1359741234262" MODIFIED="1359741234263"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def joinText(String mark) {&#xa;    node.text = SU.join(&#xa;&#x9;&#x9;c.selecteds.collect { SU.trim(it.plainText) }.toArray(), mark&#xa;&#x9;)&#xa;    c.selecteds.tail().each { it.delete() }&#xa;}&#xa;&#xa;joinText(&apos; &apos;)&#xa;" ID="ID_1426914463" CREATED="1359741234264" MODIFIED="1359741234264"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;def mark = ui.showInputDialog(&#xa;&#x9;node.delegate, &apos;Enter characters to split node text on...&apos;, &apos;&apos;&#xa;)&#xa;&#xa;if (mark) {&#xa;&#x9;splitText(Pattern.quote(mark ? mark : &apos;&apos;))&#xa;}&#xa;" ID="ID_1486370214" CREATED="1359741234272" MODIFIED="1359741234272"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;def mark = ui.showInputDialog(&#xa;&#x9;node.delegate, &apos;Enter regular expression to split node text on...&apos;, &apos;&apos;&#xa;)&#xa;&#xa;if (mark) {&#xa;&#x9;splitText((mark ? mark : &apos;&apos;))&#xa;}&#xa;" ID="ID_1570357185" CREATED="1359741234273" MODIFIED="1359741234273"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos;\\.&apos;)&#xa;" ID="ID_122261872" CREATED="1359741234274" MODIFIED="1359741234274"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos;,&apos;)&#xa;" ID="ID_1002662835" CREATED="1359741234275" MODIFIED="1359741234276"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos; &apos;)&#xa;" ID="ID_687503775" CREATED="1359741234276" MODIFIED="1359741234277"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.each { it.link.text = null }&#xa;" ID="ID_1301556811" CREATED="1359741234281" MODIFIED="1359741234282"/>
</node>
</node>
