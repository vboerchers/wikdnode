...
<node TEXT="wikdNode" FOLDED="false" ID="ID_1723255651" CREATED="1283093380553" MODIFIED="1359703536999" BACKGROUND_COLOR="#97c7dc" LINK="https://bitbucket.org/lcrees/wikdnode/">
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.every {&#x9;it.text = it.plainText.toUpperCase() }&#xa;" ID="ID_89302712" CREATED="1359703539261" MODIFIED="1359703539261"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.every { it.text = it.plainText.toLowerCase() }&#xa;" ID="ID_1023294423" CREATED="1359703539262" MODIFIED="1359703539262"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;def child&#xa;&#xa;c.selecteds.toList().every { child = it.createChild(it.text) }&#xa;&#xa;c.select(child)&#xa;" ID="ID_46968752" CREATED="1359703539263" MODIFIED="1359703539263"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;def parent&#xa;def wipe = []&#xa;&#xa;c.selecteds.toList().each {&#xa;  parent = it.parent&#xa;  parent.text = it.text&#xa;  wipe.add(it)&#xa;}&#xa;&#xa;wipe.toList().each { it.delete() }&#xa;&#xa;c.select(parent)&#xa;" ID="ID_778495166" CREATED="1359703539265" MODIFIED="1359703539266"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def joinPlainText(String mark) {&#xa;&#x9;def selecteds = c.selecteds.toList()&#xa;    node.text = SU.join(&#xa;&#x9;&#x9;selecteds.collect { SU.trim(it.plainText) }.toList(), mark&#xa;&#x9;)&#xa;    selecteds.each { it.delete() }&#xa;}&#xa;&#xa;joinText(&apos;, &apos;)&#xa;" ID="ID_1094732742" CREATED="1359703539267" MODIFIED="1359703539268"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;def joinPlainText(String mark) {&#xa;&#x9;def selecteds = c.selecteds.toList()&#xa;    node.text = SU.join(&#xa;&#x9;&#x9;selecteds.collect { SU.trim(it.plainText) }.toList(), mark&#xa;&#x9;)&#xa;    selecteds.each { it.delete() }&#xa;}&#xa;&#xa;joinText(&apos; &apos;)&#xa;" ID="ID_1828097577" CREATED="1359703539268" MODIFIED="1359703539269"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;def mark = ui.showInputDialog(&#xa;&#x9;node.delegate, &apos;Enter regular expression to split node text before...&apos;, &apos;&apos;&#xa;)&#xa;&#xa;if (mark) {&#xa;&#x9;splitText(&apos;(?=&apos; + (mark ? mark : &apos;&apos;) + &apos;)&apos;)&#xa;}&#xa;" ID="ID_651044431" CREATED="1359703539271" MODIFIED="1359703539272"/>
</node>
<node TEXT="splitAfterChars.groovy" FOLDED="true" ID="ID_1831941505" CREATED="1359702100939" MODIFIED="1359702518723">
<attribute_layout NAME_WIDTH="206" VALUE_WIDTH="206"/>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;def mark = ui.showInputDialog(&#xa;&#x9;node.delegate, &apos;Enter characters to split node text after...&apos;, &apos;&apos;&#xa;)&#xa;&#xa;if (mark) {&#xa;&#x9;splitText([&apos;(?&lt;=&apos;, Pattern.quote(mark ? mark : &apos;&apos;), &apos;)&apos;].join(&apos;&apos;))&#xa;}&#xa;" ID="ID_675782698" CREATED="1359703539272" MODIFIED="1359703539273"/>
</node>
<node TEXT="splitAfterRegex.groovy" FOLDED="true" ID="ID_102192877" CREATED="1359702100940" MODIFIED="1359702505313">
<attribute_layout NAME_WIDTH="206" VALUE_WIDTH="206"/>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;def mark = ui.showInputDialog(&#xa;&#x9;node.delegate, &apos;Enter characters to split node text on...&apos;, &apos;&apos;&#xa;)&#xa;&#xa;if (mark) {&#xa;&#x9;splitText(Pattern.quote(mark ? mark : &apos;&apos;))&#xa;}&#xa;" ID="ID_1812596910" CREATED="1359703539275" MODIFIED="1359703539276"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;def mark = ui.showInputDialog(&#xa;&#x9;node.delegate, &apos;Enter regular expression to split node text on...&apos;, &apos;&apos;&#xa;)&#xa;&#xa;if (mark) {&#xa;&#x9;splitText((mark ? mark : &apos;&apos;))&#xa;}&#xa;" ID="ID_597542220" CREATED="1359703539276" MODIFIED="1359703539277"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos;\\.&apos;)&#xa;" ID="ID_171955336" CREATED="1359703539277" MODIFIED="1359703539278"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos;,&apos;)&#xa;" ID="ID_1403039022" CREATED="1359703539278" MODIFIED="1359703539279"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;import java.util.regex.Pattern&#xa;import org.apache.commons.lang.StringUtils as SU&#xa;&#xa;&#xa;def splitText(mark) {&#xa;&#x9;def firstSplit = Boolean.parseBoolean(config.getProperty(&apos;wikd_first_split&apos;))&#xa;&#x9;c.selecteds.toList().every { ts -&gt;&#xa;&#x9;&#x9;ts.plainText.split(mark).toList().collect { SU.trim(it) }.eachWithIndex {&#xa;&#x9;&#x9;&#x9;txt, idx -&gt;&#xa;&#x9;&#x9;&#x9;if (idx == 0) {&#xa;&#x9;&#x9;&#x9;&#x9;if (firstSplit == false) {&#xa;&#x9;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;&#x9;}&#xa;      &#x9;&#x9;&#x9;ts.text = txt&#xa;&#x9;&#x9;&#x9;} else {&#xa;&#x9;&#x9;&#x9;    ts.createChild(txt)&#xa;&#x9;&#x9;&#x9;}&#xa;&#x9;&#x9;}&#xa;&#x9;}&#xa;}&#xa;splitText(&apos; &apos;)&#xa;" ID="ID_229257394" CREATED="1359703539279" MODIFIED="1359703539279"/>
</node>
...
<attribute NAME="execute_scripts_without_exec_restriction" VALUE="false"/>
<attribute NAME="execute_scripts_without_network_restriction" VALUE="false"/>
<node TEXT="// @CacheScriptContent(true)&#xa;// @ExecutionModes({ON_SINGLE_NODE})&#xa;c.selecteds.each { it.link.text = null }&#xa;" ID="ID_1350341265" CREATED="1359703539284" MODIFIED="1359703539284"/>
</node>
</node>
